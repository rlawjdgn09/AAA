var memBoardService = (function(){
	...
	function getList(board, callback, error){
		...
		var url = contextPath+"/member/restMyBiddingList";
		
		$.ajax({
			type : "get",
			url : url,
			data : {pageNum:pageNum, amount:amount, category:category, searchType : searchType,
	...
	function getTotalPageCnt(board,callback,error){
		...
		var contextPath = getContextPath();
		var url = contextPath+"/member/BidingListTotalCount";
