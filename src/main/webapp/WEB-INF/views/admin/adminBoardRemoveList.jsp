			...
			<div class="table-responsive">
				    <table id="data-table-basic" class="table table-striped" >
				        ...
				        <tbody id="tableListBody">
				        	<c:forEach var="boardList" items="${boardRemoveList}">
					        	<tr>
					        		<td>${boardList.bno}</td>
					        		<td><a href="/board/boardRead?bno=${boardList.bno}">${boardList.title}</a></td>
...
$("#closeBtn").on("click",function(){
		...
		$(".modal").modal("show");
		self.location="/admin/adminBoardRemoveList";
