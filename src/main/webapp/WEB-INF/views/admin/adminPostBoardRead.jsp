							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									...
									<div class="breadcomb-ctn">
										<h2>공지사항</h2>
										<p>관리자용 <span class="bread-ntd">게시판</span></p>
									</div>
								</div>
							</div>
...
<form id="operForm" action="/admin/adminPostBoardModify" method="get">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">                   
                        ...
                        <ul class="nav navbar-nav navbar-default">
                            <li><i class="fa fa-clock-o" style="color:DarkRed"></i>${postBoard.regDate }</li>
                        </ul>
                        <br><br>
                <div class="row">        
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <div class="nk-int-st">
                    <c:if test="${not empty postBoard.imageFileName}">
					...
					<!-- 이미지 끝  --> 
						...
						<span class="pull-right">
								<button type="button" data-oper='modify' class="btn btn-info notika-btn-info waves-effect">수정</button>
								<!-- <button type="button" data-oper='delete' class="btn btn-danger notika-btn-danger waves-effect">삭제</button> -->					
								<button type="button" data-oper='list' class="btn btn-success notika-btn-success waves-effect">목록</button>
								<br><br>
							</span>
						</div>
					 </div>
	       ...
	       <!--    <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list mg-t-30">
	                  ...
	                  <h6>댓글작성</h6>
	                      <div class="form-group">
	                          <textarea name="message" id="postReplyMessage" required="required" class="form-control" rows="5" placeholder="Your text here"></textarea>
	                      </div>                        
	                      <span class="form-group">
	                          <input type="button" id="newPostReply" class="btn notika-btn-gray btn-reco-mg btn-button-mg waves-effect" value="댓글등록">
	                      </span>
	              </div>
	              댓글 작성창 끝
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
		        <button type="button" class="btn btn-default notika-btn-default waves-effect" data-dismiss="modal">닫기</button>
		        <button type="button" id="modalPostReplyModifyBtn" class="btn btn-info notika-btn-info waves-effect">수정</button>
		      </div>
...
$("button[data-oper='modify']").on("click",function(e){
	operForm.attr("action","/admin/adminPostBoardModify").submit();
});
...
$("button[data-oper='list']").on("click",function(e){
	...
	operForm.attr("action","/admin/adminPostBoardGetList");
	operForm.submit();			
});
  			...
  			for (var i = 0, len = list.length || 0; i < len; i++) {
  				str += "<li class='media' data-rno='"+ list[i].rno + "'>"
                    ...
                    + "			<button type='button' class='pull-right btn btn-xs btn-info' name='postReplyModifyBtn' data-rno='"+ list[i].rno +"' style='float: right; margin: 0px 3px;'>수정</button>"
  					...
  					+ "			<ul class='nav navbar-nav post-nav'>"
  					+ "			<li><i class='fa fa-clock-o'></i>"+ postReplyService.postReplyDisplayTime(list[i].updateDate) +"</li>"
  					+ "			<li><i class='fa fa-reply'></i> 답글 달기</li>"
  					+ "			</ul>"
  					+ "		</div>"
  					+ "		</div></li>"
  					+ "</li>";
